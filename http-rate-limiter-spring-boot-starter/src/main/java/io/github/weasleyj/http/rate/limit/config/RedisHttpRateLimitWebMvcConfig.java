...
/**
 * Redis Http Rate Limit Web Mvc Configure
 *
 * @author weasley
 * @version 1.0.0
 */
...
public class RedisHttpRateLimitWebMvcConfig implements WebMvcConfigurer {

    private final HttpRateLimitHandler httpRateLimitHandler;

    public RedisHttpRateLimitWebMvcConfig(HttpRateLimitHandler httpRateLimitHandler) {
